...
csv_input = '/home/max/Downloads/cosine_metric_learning-master/datasets/Youtube_faces/val_file_bbox_correct_slash_path/'
...
def create_tf_example(group, path):
    ...
    tf_example = tf.train.Example(features=tf.train.Features(feature={
        ...
        'image/object/bbox/x': dataset_util.float_list_feature(x),
        'image/object/bbox/y': dataset_util.float_list_feature(y),
